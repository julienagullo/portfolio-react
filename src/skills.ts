import logoAffinity from './assets/ressources/logo-affinity.png';
import logoAnalytics from './assets/ressources/logo-analytics.png';
import logoBootstrap from './assets/ressources/logo-bootstrap.png';
import logoClaudecode from './assets/ressources/logo-claude.png';
import logoGithub from './assets/ressources/logo-github.png';
import logoJavascript from './assets/ressources/logo-javascript.png';
import logoMariadb from './assets/ressources/logo-mariadb.png';
import logoMysql from './assets/ressources/logo-mysql.png';
import logoPhotoshop from './assets/ressources/logo-photoshop.png';
import logoPhp from './assets/ressources/logo-php.png';
import logoPhpstorm from './assets/ressources/logo-phpstorm.png';
import logoPostman from './assets/ressources/logo-postman.png';
import logoReact from './assets/ressources/logo-react.png';
import logoSymfony from './assets/ressources/logo-symfony.png';
import logoUbersuggest from './assets/ressources/logo-ubersuggest.png';
import logoWordpress from './assets/ressources/logo-wordpress.png';
